...
/** Sticky copy + scrolling suggestion cards (from /landing) */
export function SuggestionsSticky() {
  return (
    <section
      id="suggestions"
      className="bg-[var(--background)] px-6 py-20 md:px-10 md:py-28"
    >
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.15fr] lg:items-start lg:gap-16">
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Reveal delayMs={70}>
            <h2 className="mt-4 font-[family-name:var(--font-cursive)] text-3xl leading-[1.12] tracking-tight text-neutral-950 sm:text-4xl md:text-[2.75rem]">
              Skin guidance and clothing direction — in one private loop.
            </h2>
          </Reveal>
          <Reveal delayMs={140}>
            <p className="mt-5 max-w-md text-base leading-relaxed text-neutral-500">
              Explainable feature scores plus paired suggestions: what to do for
              your skin, and how to dress so those features read stronger.
              Assess → act → prove, without comparing you to strangers.
            </p>
          </Reveal>
          <Reveal delayMs={200}>
            <Link
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <article className="flex flex-col justify-between rounded-[1.5rem] bg-neutral-950 p-6 text-white sm:col-span-2 sm:flex-row sm:items-end sm:p-8">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/55 sm:mt-0 sm:text-right">
              Full breakdowns unlock confidence labels and both skin and
              clothing recommendation sets.
            </p>
          </article>
        </div>
      </div>
