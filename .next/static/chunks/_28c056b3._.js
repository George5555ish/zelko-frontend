...
function SkinGlassLens(param) {
    let { active, imageSrc, useVideoZoom = false, syncVideoRef, stops: stopsProp, stop, objectPosition = "50% 50%", className = "", enterDelayMs = DEFAULT_ENTER_DELAY_MS, dwellMs = DEFAULT_DWELL_MS, fadeMs = DEFAULT_FADE_MS, gapMs = DEFAULT_GAP_MS, loop = true, persist = false, exiting = false, lite = false } = param;
    var _stops_, _stops_1, _stops_2;
    _s();
    const stops = stopsProp !== null && stopsProp !== void 0 ? stopsProp : stop ? [
        stop
    ] : [];
    const stopKey = stops.map((s)=>"".concat(s.label, ":").concat(s.x, ":").concat(s.y, ":").concat(s.motion)).join("|");
    ...
    var _stops__label;
    const [label, setLabel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])((_stops__label = (_stops_2 = stops[0]) === null || _stops_2 === void 0 ? void 0 : _stops_2.label) !== null && _stops__label !== void 0 ? _stops__label : "");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SkinGlassLens.useEffect": ()=>{
            ...
            const moveLens = {
                "SkinGlassLens.useEffect.moveLens": (xFrac, yFrac)=>{
                    posRef.current = {
                        x: xFrac,
                        y: yFrac
                    };
...
_s(SkinGlassLens, "38nf3FVBneI8WZrzNuiaQo7jhV0=");
_c = SkinGlassLens;
var _c;
...
function LandingHero() {
    ...
    const videoStageRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const copyLayerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const parallaxRaf = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        "LandingHero.useEffect": ()=>{
            ...
            const advanceId = window.setTimeout({
                "LandingHero.useEffect.advanceId": ()=>{
                    ...
                    setLandmarkBatch({
                        "LandingHero.useEffect.advanceId": (prev)=>prev + 1
                    }["LandingHero.useEffect.advanceId"]);
                    setLandmarksVisible(true);
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LandingHero.useEffect": ()=>{
            ...
            const id = window.setTimeout({
                "LandingHero.useEffect.id": ()=>setLensesDone(true)
            }["LandingHero.useEffect.id"], LENSES_MAX_MS);
            return ({
                "LandingHero.useEffect": ()=>window.clearTimeout(id)
            })["LandingHero.useEffect"];
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LandingHero.useEffect": ()=>{
            const applyParallax = {
                "LandingHero.useEffect.applyParallax": ()=>{
                    const y = window.scrollY;
                    setScrolled(y >= 30);
                    const video = videoStageRef.current;
                    const copy = copyLayerRef.current;
                    if (video) {
                        video.style.transform = "translate3d(0, ".concat(y * 0.32, "px, 0)");
                    }
                    if (copy) {
                        copy.style.transform = "translate3d(0, ".concat(y * -0.1, "px, 0)");
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LandingHero.useEffect": ()=>{
            ...
            }["LandingHero.useEffect.id"], cycleMs);
            return ({
                "LandingHero.useEffect": ()=>window.clearTimeout(id)
            })["LandingHero.useEffect"];
        }
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    landmarksReady && !landmarksDone && ((_LANDMARK_BATCHES_landmarkBatch = LANDMARK_BATCHES[landmarkBatch]) !== null && _LANDMARK_BATCHES_landmarkBatch !== void 0 ? _LANDMARK_BATCHES_landmarkBatch : []).map((mark, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "hero-landmark pointer-events-none ".concat(landmarksVisible ? "is-on" : ""),
                            style: {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: "/contact",
                                    className: "hero-word hidden rounded-lg border px-4 py-2 text-sm font-medium transition lg:inline-flex ".concat(scrolled ? "border-neutral-900/80 hover:bg-white/50" : "border-white/80 hover:bg-white/10", " ").concat(started ? "is-in" : ""),
                                    style: {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: "/login",
                                    className: "hero-word hidden text-sm font-medium transition sm:inline ".concat(scrolled ? "hover:text-neutral-950" : "hover:text-white/80", " ").concat(started ? "is-in" : ""),
                                    style: {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "hero-word mb-4 inline-flex w-fit items-center rounded-full border border-neutral-200/80 bg-white/85 px-3.5 py-1.5 text-xs text-neutral-600 shadow-sm backdrop-blur-sm sm:mb-5 sm:text-sm ".concat(started ? "is-in" : ""),
                                style: {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "hero-word mt-6 sm:mt-7 ".concat(started ? "is-in" : ""),
                                style: {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: STATS.map((stat, i)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "hero-word shrink-0 text-neutral-400 ".concat(started ? "is-in" : ""),
                                                style: {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "hero-word text-base font-semibold tracking-tight text-neutral-900 ".concat(started ? "is-in" : ""),
                                                        style: {
                                                            transitionDelay: "".concat(baseDelay + 40, "ms")
                                                        },
                                                        children: stat.value
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/LandingHero.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "hero-word text-[11px] leading-snug text-neutral-500 ".concat(started ? "is-in" : ""),
                                                        style: {
...
_s(LandingHero, "72cYSc/dmwxF+o8zDz0oiwBBfLA=");
_c = LandingHero;
function LogoMark() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        width: "22",
...
//# sourceMappingURL=_28c056b3._.js.map