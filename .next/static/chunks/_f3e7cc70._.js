...
function PhotoUpload(param) {
    ...
    const processFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoUpload.useCallback[processFile]": async (slot)=>{
            ...
            try {
                ...
                void (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mediapipe$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractFaceLandmarksFromFile"])(slot.file).catch({
                    "PhotoUpload.useCallback[processFile]": (err)=>{
    ...
    const runAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoUpload.useCallback[runAnalysis]": async ()=>{
            const fileIds = slots.filter({
                "PhotoUpload.useCallback[runAnalysis].fileIds": (s)=>s.status === "accepted" && s.fileId
            }["PhotoUpload.useCallback[runAnalysis].fileIds"]).map({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-5 flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed px-6 py-10 transition ".concat(dragging ? "border-[var(--accent)] bg-[var(--accent-soft)]/50" : "border-neutral-300 bg-white hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]/30", " ").concat(!canAddMore ? "cursor-not-allowed opacity-60" : ""),
                onClick: ()=>{
...
_s(PhotoUpload, "GRX5jUBBX3++Admu2a+N7ecaz38=", false, function() {
    return [
...
_c3 = FileStackGraphic;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "PhotoUpload");
__turbopack_context__.k.register(_c1, "StatusLabel");
__turbopack_context__.k.register(_c2, "UploadIcon");
__turbopack_context__.k.register(_c3, "FileStackGraphic");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f3e7cc70._.js.map