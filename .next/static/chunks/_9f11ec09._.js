...
function PhotoUpload(param) {
    let { consent } = param;
    var _user_reportIds, _assessLandmarkQuality;
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, isAuthed, ready: authReady } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$auth$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthUser"])();
    ...
    const [proLimitOpen, setProLimitOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [proBusy, setProBusy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [proError, setProError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [reportUsed, setReportUsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const freeReportsUsed = isAuthed ? reportUsed !== null && reportUsed !== void 0 ? reportUsed : (_user_reportIds_length = user === null || user === void 0 ? void 0 : (_user_reportIds = user.reportIds) === null || _user_reportIds === void 0 ? void 0 : _user_reportIds.length) !== null && _user_reportIds_length !== void 0 ? _user_reportIds_length : 0 : null;
    const atFreeReportLimit = Boolean(isAuthed) && !(user === null || user === void 0 ? void 0 : user.isPro) && freeReportsUsed != null && freeReportsUsed >= FREE_REPORT_CAP;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoUpload.useEffect": ()=>{
            if (!authReady || !isAuthed || (user === null || user === void 0 ? void 0 : user.isPro)) {
                setReportUsed(null);
                return;
            }
            void ({
                "PhotoUpload.useEffect": async ()=>{
                    try {
                        const { reports } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMyReports"])();
                        const baselines = reports.filter({
                            "PhotoUpload.useEffect.baselines": (r)=>r.kind !== "target_look"
                        }["PhotoUpload.useEffect.baselines"]);
                        setReportUsed(baselines.length);
                    } catch (e) {
                        var _user_reportIds;
                        var _user_reportIds_length;
                        setReportUsed((_user_reportIds_length = user === null || user === void 0 ? void 0 : (_user_reportIds = user.reportIds) === null || _user_reportIds === void 0 ? void 0 : _user_reportIds.length) !== null && _user_reportIds_length !== void 0 ? _user_reportIds_length : 0);
                    }
                }
            })["PhotoUpload.useEffect"]();
        }
        ...
        user === null || user === void 0 ? void 0 : user.reportIds
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoUpload.useEffect": ()=>{
    ...
    const openProCheckout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PhotoUpload.useCallback[openProCheckout]": async ()=>{
            setProError(null);
            setProBusy(true);
            try {
                ...
                if (checkout.devUnlock) {
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["devUnlockPro"])();
                    setProLimitOpen(false);
                    setReportUsed(null);
                ...
                var _checkout_error;
                setProError((_checkout_error = checkout.error) !== null && _checkout_error !== void 0 ? _checkout_error : "Checkout unavailable right now.");
            } catch (err) {
    ...
    }["PhotoUpload.useCallback[openProCheckout]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhotoUpload.useEffect": ()=>{
            if (slots.length === 0) {
                setCarouselIndex(0);
        ...
        "PhotoUpload.useCallback[runAnalysis]": async ()=>{
            ...
            try {
                ...
                try {
                    ...
                    setError(res.ok ? "Analysis returned an unexpected response." : res.status === 500 || res.status === 502 || res.status === 504 ? "Analysis timed out on the way back. Check your dashboard — the report may still have been created." : "Analysis failed (".concat(res.status, "). Try again in a moment."));
                    return;
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isAuthed && !(user === null || user === void 0 ? void 0 : user.isPro) && freeReportsUsed != null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    " ",
                                    FREE_REPORT_CAP,
                                    atFreeReportLimit ? " — limit reached" : " · ".concat(Math.max(0, FREE_REPORT_CAP - freeReportsUsed), " left")
                                ]
                            }, void 0, true, {
                                fileName: "[project]/components/PhotoUpload.tsx",
                                lineNumber: 556,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "upload-glass-inset mt-3 flex cursor-pointer items-center gap-3 px-3 py-2.5 transition ".concat(dragging ? "ring-2 ring-white/30" : "", " ").concat(!canAddMore ? "cursor-not-allowed opacity-55" : "hover:bg-white/8"),
                                onClick: ()=>{
            ...
            proLimitOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            proError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(PhotoUpload, "pDasijX4tZc7BHr806ju0ZdTkxE=", false, function() {
    return [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$personalization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PRIORITY_FEATURE_OPTIONS"].map((param)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "rounded-full border px-2.5 py-0.5 text-[11px] font-medium transition ".concat(selected ? "border-white/50 bg-white text-neutral-950" : "border-white/20 bg-white/5 text-white/65 hover:bg-white/10 hover:text-white"),
                        children: label
                    }, key, false, {
                        fileName: "[project]/components/PhotoUpload.tsx",
                        lineNumber: 905,
...
//# sourceMappingURL=_9f11ec09._.js.map