...
function EbayShopModal(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EbayShopModal.useEffect": ()=>{
            ...
            void ({
                "EbayShopModal.useEffect": async ()=>{
                    try {
                        ...
                        if (ac.signal.aborted) return;
                        if (!res.ok) {
                            setError(data.error || "Search failed (".concat(res.status, ")."));
                            setItems([]);
                            return;
                        }
            ...
            return ({
                "EbayShopModal.useEffect": ()=>ac.abort()
            })["EbayShopModal.useEffect"];
        }
    }["EbayShopModal.useEffect"], [
        active.query
...
_s1(EbayShopModal, "3a4WGIUzx2hoS/cdRKLB8fOExE8=");
_c1 = EbayShopModal;
...
_s(AppearanceJourney, "o0gl+tyABnoUw2uoeibQwUbTz+Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$use$2d$auth$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthUser"]
    ];
});
...
//# sourceMappingURL=_49dc1a9c._.js.map