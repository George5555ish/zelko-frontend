...
function labelFor(index) {
    if (index === 0) return "Signature look";
    if (index === 1) return "Alternate piece";
    return "Elevated take";
}
    ...
    return LOOK_SLOTS.map((index)=>{
        ...
        if ((existing === null || existing === void 0 ? void 0 : existing.status) === "failed") {
            return {
                ...existing,
                phase: "failed",
                error: existing.error ? friendlyGenError(0, existing.error) : "Generation failed."
            };
        }
        var _existing_id, _existing_label, _existing_recommendedStyle;
        return {
            id: (_existing_id = existing === null || existing === void 0 ? void 0 : existing.id) !== null && _existing_id !== void 0 ? _existing_id : "look-".concat(index),
            index,
            label: (_existing_label = existing === null || existing === void 0 ? void 0 : existing.label) !== null && _existing_label !== void 0 ? _existing_label : labelFor(index),
            status: "pending",
            fileId: null,
...
function isGatewayTimeout(status, raw) {
    ...
    return status === 502 || status === 504 || status === 408 || /^Internal\s/i.test(text) || text.startsWith("<!DOCTYPE") || text.includes("Unexpected token") || /timed?\s*out/i.test(text) || /took too long/i.test(text);
}
...
/**
 * After a proxy timeout the backend may still finish. Poll until this look
 * leaves pending (or we give up).
 */ async function pollLookUntilSettled(reportId, lookIndex, opts) {
    var _opts_maxMs;
    const maxMs = (_opts_maxMs = opts.maxMs) !== null && _opts_maxMs !== void 0 ? _opts_maxMs : 180_000;
    var _opts_intervalMs;
    const intervalMs = (_opts_intervalMs = opts.intervalMs) !== null && _opts_intervalMs !== void 0 ? _opts_intervalMs : 2500;
    ...
    while(Date.now() - started < maxMs){
        ...
        if (look && look.status !== "pending") return look;
        await sleep(intervalMs);
    }
    return null;
}
function LooksReveal(param) {
    let { reportId, journey, onJourneyUpdate, onFinish } = param;
    _s();
    ...
    const applyJourney = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LooksReveal.useCallback[applyJourney]": (next)=>{
            onJourneyUpdate(next);
            setLooks({
                "LooksReveal.useCallback[applyJourney]": (prev)=>{
                    const seeded = seedLooks(next.looks);
                    // Keep in-flight generating markers for looks not yet settled server-side.
                    return seeded.map({
                        "LooksReveal.useCallback[applyJourney]": (s, i)=>{
                            const was = prev[i];
                            if (s.phase === "waiting" && (was === null || was === void 0 ? void 0 : was.phase) === "generating" && activeIndex === i) {
                                return {
                                    ...s,
                                    phase: "generating"
                                };
                    ...
                    }["LooksReveal.useCallback[applyJourney]"]);
                }
            }["LooksReveal.useCallback[applyJourney]"]);
        }
    }["LooksReveal.useCallback[applyJourney]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LooksReveal.useEffect": ()=>{
            var _journey_looks;
            if ((_journey_looks = journey.looks) === null || _journey_looks === void 0 ? void 0 : _journey_looks.some({
                "LooksReveal.useEffect": (l)=>l.status === "ready" || l.status === "failed"
            }["LooksReveal.useEffect"])) {
                setLooks({
                    "LooksReveal.useEffect": (prev)=>{
                        ...
                        return next.map({
                            "LooksReveal.useEffect": (s, i)=>{
                                var _prev_i;
                                if (s.phase === "ready" || s.phase === "failed") return s;
                                if (((_prev_i = prev[i]) === null || _prev_i === void 0 ? void 0 : _prev_i.phase) === "generating") {
                                    return {
                                        ...s,
                                        phase: "generating"
                                    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LooksReveal.useEffect": ()=>{
            ...
            abortRef.current = ac;
            const initial = seedLooks(journey.looks);
            setLooks(initial);
            void ({
                "LooksReveal.useEffect": async ()=>{
                    for (const lookIndex of LOOK_SLOTS){
                        if (ac.signal.aborted) return;
                        const existing = initial[lookIndex];
                        if ((existing === null || existing === void 0 ? void 0 : existing.phase) === "ready" && existing.fileId) {
                            setLooks({
                                "LooksReveal.useEffect": (prev)=>mergeLook(prev, {
                                        ...existing,
                                        phase: "ready"
                                    })
                            }["LooksReveal.useEffect"]);
                        ...
                        let settled = null;
                        try {
                            var _data_journey_looks, _data_journey;
                            ...
                            if (data.look && data.look.status !== "pending") {
                                settled = data.look;
                                if (data.journey) onJourneyUpdate(data.journey);
                            } else if ((_data_journey = data.journey) === null || _data_journey === void 0 ? void 0 : (_data_journey_looks = _data_journey.looks) === null || _data_journey_looks === void 0 ? void 0 : _data_journey_looks[lookIndex]) {
                                const fromJourney = data.journey.looks[lookIndex];
                                if (fromJourney.status !== "pending") {
                                    settled = fromJourney;
                                    onJourneyUpdate(data.journey);
                                }
                            }
                            // Proxy often dies before fal finishes — keep pulsing and poll.
                            if (!settled && (isGatewayTimeout(res.status, raw) || !res.ok)) {
                                settled = await pollLookUntilSettled(reportId, lookIndex, {
                                    signal: ac.signal
                                });
                                if (settled) {
                                    const refreshed = await fetchJourney(reportId);
                                    if (refreshed) onJourneyUpdate(refreshed);
                                } else if (!res.ok) {
                                    var _initial_lookIndex;
                                    var _initial_lookIndex_recommendedStyle, _data_error;
                                    settled = {
                                        ...
                                        error: friendlyGenError(res.status, (_data_error = data.error) !== null && _data_error !== void 0 ? _data_error : raw.slice(0, 120))
                                    };
                                }
                            }
                        } catch (err) {
                            if (ac.signal.aborted) return;
                            // Network / abort mid-flight — still try polling in case backend saved.
                            settled = await pollLookUntilSettled(reportId, lookIndex, {
                                signal: ac.signal,
                                maxMs: 120_000
                            });
                        ...
                        if (ac.signal.aborted) return;
                        if (settled) {
                            const phase = settled.status === "ready" && settled.fileId ? "ready" : settled.status === "failed" ? "failed" : "waiting";
                            setLooks({
                                "LooksReveal.useEffect": (prev)=>mergeLook(prev, {
                                        ...settled,
                                        error: phase === "failed" && settled.error ? friendlyGenError(0, settled.error) : settled.error,
                                        phase
                                    })
                            }["LooksReveal.useEffect"]);
                        }
                    ...
                    setActiveIndex(null);
                    const refreshed = await fetchJourney(reportId);
                    if (refreshed && !ac.signal.aborted) applyJourney(refreshed);
                }
            })["LooksReveal.useEffect"]();
            return ({
                "LooksReveal.useEffect": ()=>{
        ...
        // Intentionally once on mount — reportId is stable for this stage.
        // eslint-disable-next-line react-hooks/exhaustive-deps
        }
    }["LooksReveal.useEffect"], [
        reportId
    ]);
    const readyCount = looks.filter((l)=>l.phase === "ready").length;
    const generating = looks.some((l)=>l.phase === "generating");
    const allSettled = looks.length === 3 && looks.every((l)=>l.phase === "ready" || l.phase === "failed");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "ai-reveal",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: [
                            "Three outfits from your style picks — same face, different clothes.",
                            generating && activeIndex != null ? " Styling look ".concat(activeIndex + 1, " of 3…") : readyCount > 0 ? " ".concat(readyCount, " ready.") : ""
                        ]
                    }, void 0, true, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 336,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "ai-looks-grid",
                children: looks.map((look)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LookCard, {
                        look: look
                    }, look.id || look.index, false, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 348,
                        columnNumber: 11
                    }, this))
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: allSettled ? "Finish this pass" : "Continue while looks finish"
                    }, void 0, false, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 353,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "ai-reveal__note",
                        children: "eBay shoppable matches come next — these stills preview how your style profile dresses your face."
                    }, void 0, false, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 361,
                        columnNumber: 9
...
_s(LooksReveal, "hxb6FSk4/BZorcnTwFIch0jDRwo=");
_c = LooksReveal;
/** Short user-facing copy — never dump raw fal JSON into the card. */ function friendlyGenError(status, raw) {
    const text = raw.replace(/\s+/g, " ").trim();
...
function LookCard(param) {
    let { look } = param;
    const loading = look.phase === "generating";
    const waiting = look.phase === "waiting";
    const failed = look.phase === "failed";
    const ready = look.phase === "ready" && look.fileId;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
        className: "ai-look-card report-glass".concat(loading ? " is-loading" : "").concat(failed ? " is-failed" : "").concat(waiting ? " is-waiting" : "").concat(ready ? " is-ready" : ""),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "ai-look-card__media",
                children: ready ? // eslint-disable-next-line @next/next/no-img-element
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: failed ? "Couldn’t generate" : loading ? "Styling look…" : "Waiting…"
                        }, void 0, false, {
                            fileName: "[project]/components/appearance/LooksReveal.tsx",
                            lineNumber: 414,
                            columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    look.recommendedStyle ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        className: "ai-look-card__skeleton"
                    }, void 0, false, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 429,
                        columnNumber: 11
                    }, this) : waiting ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "ai-look-card__hint",
                        children: "Up next"
                    }, void 0, false, {
                        fileName: "[project]/components/appearance/LooksReveal.tsx",
                        lineNumber: 431,
                    ...
                    failed && look.error ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
__turbopack_context__.k.register(_c1, "LookCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1ec87ebe._.js.map